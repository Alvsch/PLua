...
EOF
        ...
        stage('Collect Artifacts') {
            ...
            steps {
                ...
                sh '''
                    cp target/x86_64-unknown-linux-gnu/release/*.so artifacts/libplua_x86_64_linux.so
                    cp target/aarch64-unknown-linux-gnu/release/*.so artifacts/libplua_aarch64_linux.so
                    cp target/x86_64-pc-windows-gnu/release/*.dll artifacts/plua_x86_64_windows.dll
                '''
